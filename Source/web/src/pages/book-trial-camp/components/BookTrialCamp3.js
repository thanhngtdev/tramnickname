import EmailIcon from "components/booking/EmailIcon";
import TrainingIcon1 from "components/booking/TrainingIcon1";
import TrainingIcon2 from "components/booking/TrainingIcon2";
import TrainingIcon3 from "components/booking/TrainingIcon3";
    ...
    return (
      <div className="tab-3">
        <div style={{ marginBottom: "4rem" }}>
          <h2>
            Unfortunately, the trial session date you have requested at this
            academy is fully booked
          </h2>
          <label>
            <a
              href="#"
            ...
            <div className="row">
              <div className="col-4">
                <div className="item" style={{ position: "relative" }}>
                  ...
                  <h3 className="title" style={{ textAlign: "center" }}>
                    ...
                    {props.data.siteSelected && props.data.siteSelected.ms_name}{" "}
                    work?
                  </h3>
                  <div className="description" style={{ textAlign: "center" }}>
                    Sign up for a free session on the Wednesday class at 5pm.
                  </div>
                  <p
                    style={{
                      marginTop: 25,
              ...
              <div className="col-4">
                <div className="item" style={{ position: "relative" }}>
                  <TrainingIcon2 />
                  <h3 className="title" style={{ textAlign: "center" }}>
                    The Saturday class is super popular. Please join our waiting
                    list
                  </h3>
                  <div className="description" style={{ textAlign: "center" }}>
                    We will email you or call you as soon as a position opens
                    up. You can check in your order in the queue in your Parent
                    Area account.
                  </div>
                  <Button
                    style={styles.button}
                    onClick={() =>
                      dispatch({
                        ...
                        course_id: props.data.courseSelected.course_id,
                        child_id: "",
                        message: "",
                      })
                    }
              ...
              <div className="col-4">
                <div className="item" style={{ position: "relative" }}>
                  ...
                  <div className="description" style={{ textAlign: "center" }}>
                    No need to resubmit the form - you just need to choose a new
                    nearby academy and class time.
                  </div>
                  <Button
                    style={styles.button}
                    onClick={() => {
                      if (props.findAcademy) props.findAcademy();
                    }}
                  >
                    another academy
                  </Button>
        ...
        <p>
          You can login to your Parent Area account anytime here to manage your
          booking or add more children.
        </p>
        <p>
          You can come back to the We Make Footballers website and login anytime
          or use the link in email we just sent you.
        </p>
      </div>
    );
  }
    ...
    return (
      <>
        <div style={{ marginBottom: "4rem" }}>
          {paidBooking ? (
            <h2>
              Woohoo! Tony is booked in for a Holiday Camp at Isleworth Academy
              on the following dates:
            </h2>
          ) : (
            <h2>
              The booking status is {dataBooking.payment_status} Please log in
              to Parent Area{" "}
              <a
        ...
        <div className="container">
          <div className="success-booking">
            ...
            >
              <p>
                We have emailed you all the details. Click the link in the email
                to confirm your address and start your child’s footballing
                journey.
              </p>
            </div>
          </div>
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <p>
              You can come back to the We Make Footballers website and login
              anytime or use the link in email we just sent you.
            </p>
          </div>
        </div>
      </>
