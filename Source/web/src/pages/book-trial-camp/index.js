...
import HolidayCampTabSpace from "components/include/HolidayCampTabSpace";
    ...
    if (siteReducer.type) {
      if (siteReducer.type === siteActionType.BOOK_EVENT_SIGNUP_SUCCESS) {
        ...
        if (data.status === 200) {
          ...
          setBookSuccess(2);
          setBookMessage("Cannot register user on Parent Area system");
          setActiveTab(3);
        } else {
      ...
      <div className="holiday-camp">
        <div className="container">
          <div className="tab-view">
            <div
              className={`wrap-tab ${activeTab === 1 ? "active" : ""} ${
                activeTab > 1 ? "filled" : ""
              }`}
            >
              <button>1</button>
            ...
            <HolidayCampTabSpace />
            <div
              className={`wrap-tab ${activeTab === 2 ? "active" : ""} ${
                activeTab > 2 ? "filled" : ""
              }`}
            >
              <button>2</button>
            ...
            <HolidayCampTabSpace />
            <div className={`wrap-tab ${activeTab === 3 ? "active" : ""}`}>
              <button>3</button>
            </div>
          </div>
