                ...
                <div
                    ...
                    <a
                        href={
                            ...
                            defaultAcademy.social.length > 0
                                ? defaultAcademy.social[0].link
                                : '#'
                        }>
                        {fbIcon}
                    </a>
                    <a
                        href={
                            defaultAcademy &&
                            defaultAcademy.social &&
                            defaultAcademy.social.length > 2
                                ? defaultAcademy.social[2].link
                                : '#'
                        }
                        style={{ margin: '0 2rem' }}>
                        {twIcon}
                    ...
                    <a
                        href={
                            defaultAcademy &&
                            defaultAcademy.social &&
                            defaultAcademy.social.length > 3
                                ? defaultAcademy.social[3].link
                                : '#'
                        }>
                        {igIcon}
                    </a>
