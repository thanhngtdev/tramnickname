...
class com_wiris_util_xml_WCharacterBase {
	...
	static $tallAccents;
	static $coloredEmoticon = "231B,23E9-23EC,23F0,23F3,2614-2615,261D,264A-2653,267F,2693,26A1,26BD-26BE,26C4-26C5,26CE,26D4,26EA,26F2-26F3,26F5,26F9-26FA,26FD,2705,270A-270D,2728,274C,274E,2753-2755,2757,2795-2797,27B0,27BF,2B55";
	...
	static function isSupported($c) {
		$isColoredEmoticon = com_wiris_system_ArrayEx::contains(com_wiris_util_xml_WCharacterBase::$coloredEmoticonList, com_wiris_util_xml_WCharacterBase_3($c));
		return !$isColoredEmoticon && (com_wiris_util_xml_WCharacterBase::isArabian($c) || com_wiris_util_xml_WCharacterBase::isDisplayedWithStix($c) || com_wiris_util_xml_WCharacterBase::isGreek($c) || com_wiris_util_xml_WCharacterBase::isHorizontalOperator($c) || com_wiris_util_xml_WCharacterBase::isInvisible($c) || com_wiris_util_xml_WCharacterBase::isLetter($c) || com_wiris_util_xml_WCharacterBase::isOp($c) || com_wiris_util_xml_WCharacterBase::isStretchyLTR($c) || com_wiris_util_xml_WCharacterBase::isTallAccent($c) || com_wiris_util_xml_WCharacterBase::isWord($c));
	}
	static $coloredEmoticonList;
...
com_wiris_util_xml_WCharacterBase::$coloredEmoticonList = com_wiris_util_xml_WCharacterBase::getUnicodesRangedStringList(com_wiris_util_xml_WCharacterBase::$coloredEmoticon);
...
function com_wiris_util_xml_WCharacterBase_3(&$c) {
	{
		$s = new haxe_Utf8(null);
		$s->addChar($c);
		return $s->toString();
