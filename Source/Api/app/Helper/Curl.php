...
class Curl
{
    ...
    function __construct($useCookie = false) {
        ...
        $this->user_agent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_1) AppleWebKit/537.36 (K HTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36';
    }
    ...
    function getImage($url,$saveto){
        $raw = $this->get($url);
        if($raw->headers['Status-Code'] == 200) {
