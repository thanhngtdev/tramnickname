...
@section('main-header')
    <h1 class="page-header">Micro site news <small>list</small></h1>
    <a href="{!! route('admin.article.getAdd',$data['site']->ms_id) !!}"
...
@section('main-content')
    ...
    @if(method_exists($data['lstArticle'], 'links')) {!! $data['lstArticle']->links() !!} @endif
@endsection
